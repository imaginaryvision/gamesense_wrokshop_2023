...
local refs = {
	["rage"] = {
		...
		["logs"] = ui_reference("RAGE", "Other", "Log misses due to spread"),
	...
	["useless_features"] = {
		...
		["double_tap_fl_limit"] = ui_reference("RAGE", "Aimbot", "Double tap fake lag limit"),
		["double_tap_options"] = ui_reference("RAGE", "Aimbot", "Double tap quick stop"),
...
local hide_useless_features = function(value)
	if (value == false) then
		...
		ui_set_visible(refs.useless_features.fake_peek, value)
	else
		ui_set_visible(refs.useless_features.double_tap[1], value)
		ui_set_visible(refs.useless_features.double_tap[2], value)
		ui_set_visible(refs.useless_features.on_shot_aa[1], value)
