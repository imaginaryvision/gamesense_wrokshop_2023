...
local math_floor, math_fmod, math_frexp, math_ldexp, string_reverse, table_insert, ipairs, print, string_byte, table_remove, type, error, pairs, assert, string_sub, table_concat = math.floor, math.fmod, math.frexp, math.ldexp, string.reverse, table.insert, ipairs, print, string.byte, table.remove, type, error, pairs, assert, string.sub, table.concat
